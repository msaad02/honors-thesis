...
import { OperandPortion } from '@/utils/server/operandMessages';
...
export const ChatInput: FC<Props> = ({
  ...
  const handleSend = async () => {
    ...
    const withOperandContent = await OperandPortion(content);
  
    onSend({ role: 'user', content: withOperandContent });
    setContent('');
